<template>
    <div>
        ...
        <div class="bind_content">
            ...
            <div class="bind_list">
                <div class="bind_img" @click="bindwx"><img src="../../assets/weixin.png" alt=""></div>
                <div class="bind_coin">
                    <span>绑定微信号码</span>
                </div>
                <span class="bind_span"  v-if="statuslist.weixinopenid == ''">未绑定</span>
            ...
            <div class="bind_list">
                ...
                <span class="bind_span" v-if="statuslist.qqopenid == ''">未绑定</span>
            ...
            <div class="bind_list">
                ...
                <span class="bind_span" v-if="statuslist.weiboopenid == ''">未绑定</span>
